    ...
    <div className="spms-card card border-0 h-100" style={{ borderRadius: 16, boxShadow: '0 4px 20px rgba(15, 23, 42, .06)' }}>
      <div className="card-body">
        <div className="d-flex align-items-center gap-3">
          <div className="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 placeholder-glow" style={{ width: 48, height: 48 }}>
...
// Skeleton component for qualification cards
...
export function FastFacultyDashboard() {
  ...
  const combinedData: FacultyDashboardData | null = statsData && analyticsData ? {
    ...statsData,
    ...analyticsData,
  ...
  return (
    <div className="d-flex flex-column gap-4">
      ...
      <section>
        ...
        <div className="row g-3">
          {statsLoading ? (
            ...
            <>
              <div className="col-6 col-xl-3"><StatCardSkeleton /></div>
              <div className="col-6 col-xl-3"><StatCardSkeleton /></div>
              <div className="col-6 col-xl-3"><StatCardSkeleton /></div>
              <div className="col-6 col-xl-3"><StatCardSkeleton /></div>
            </>
            ...
            <>
              ...
              <div className="col-6 col-xl-3">
                <StatCard
                  ...
                  value={statsData?.approvedMedical ?? 0}
              ...
              <div className="col-6 col-xl-3">
                <StatCard
                  ...
                  value={statsData?.studentsWithViolations ?? 0}
              ...
              <div className="col-6 col-xl-3">
                <StatCard
                  ...
                  value={statsData?.pendingMedicalCount ?? 0}
      ...
      <section>
        ...
        <div className="row g-3">
          {analyticsLoading ? (
            // Show skeleton qualification cards while loading analytics
            <>
            ...
            // Show actual qualification data once loaded
            [
              {
                label: 'Programming track',
                value: analyticsData?.qualifiedProgramming ?? 0,
                hint: 'At least one programming skill assigned',
                icon: 'bi-code-slash',
              },
              {
                label: 'Sports try-out ready',
                value: analyticsData?.qualifiedSportsTryout ?? 0,
                hint: 'Cleared medically + sport on file',
                icon: 'bi-trophy',
              },
              {
                label: 'Academic competitions',
                value: analyticsData?.qualifiedAcademic ?? 0,
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="fs-3 fw-bold">{q.value}</div>
        ...
        <div className="row g-4">
          <div className="col-12 col-lg-6">
            <ChartCard 
              ...
              subtitle="Latest-term GWA distribution (Philippine scale)."
              loading={analyticsLoading}
            >
              {!analyticsLoading && combinedData ? (
                combinedData.gwaDistribution.length > 0 ? (
                  <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={undefined}>
                    <BarChart data={combinedData.gwaDistribution} margin={{ top: 8, right: 8, left: 0, bottom: 48 }}>
                  ...
                  <div className="spms-muted small d-flex align-items-center justify-content-center h-100">
                    No academic records yet — add terms under Faculty → Academic.
                  </div>
                )
              ) : null}
            </ChartCard>
          ...
          <div className="col-12 col-lg-6">
            <ChartCard 
              title="Top students by latest GWA" 
              subtitle="Lower GWA is stronger. Includes skill assignment count."
              loading={analyticsLoading}
            >
              {!analyticsLoading && combinedData ? (
                combinedData.topByGwa.length > 0 ? (
          ...
          <div className="card-body p-0">
            {isLoading ? (
              <div className="p-4 text-center">
                ...
                <span className="spms-muted small">Loading medical queue...</span>
              </div>
            ) : error ? (
              <div className="p-4 text-center">
            ...
            ) : combinedData && combinedData.pendingMedicalRows.length === 0 ? (
              ...
              <div className="table-responsive">
                <table className="table table-hover align-middle mb-0">
                  ...
                  <tbody>
                    {combinedData.pendingMedicalRows.map((row) => (
                      <tr key={row.id}>
                        <td className="ps-4">
